...
## Usage Structure
<p>Ad <b>showip.php</b> file to show server info, yo can edit this file to use with other php functions. There is another showipiframe.php ready to show on a iframe element on your site.
